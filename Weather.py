...
# --------- User Settings ---------
CITY = "Surabaya"
GPS_COORDS = "-7.321897,112.768057"
DARKSKY_API_KEY = "deb86714fa1117d184f8f8e16832460f"
BUCKET_NAME = ":partly_sunny: " + CITY + " Weather"
BUCKET_KEY = "ds1"
ACCESS_KEY = "ist_J05PacC7AYY3xQJxMWibp_kF82dht4wC"
MINUTES_BETWEEN_READS = 20
...
def main():
	...
	if ('currently' not in curr_conditions):
		print ("Error! Dark Sky API call failed, \ncheck your GPS coordinates and make sure your Dark Sky API key is valid!")
	...
	while True:
		...
		curr_conditions = get_current_conditions()
		if ('currently' not in curr_conditions):
			print ("Error! Dark Sky API call failed.\n Skipping a reading then continuing ...")
			print (curr_conditions)
		else:
			streamer.log("Location", GPS_COORDS)
			...
			if 'cloudCover' in curr_conditions['currently'] and float(curr_conditions['currently']['cloudCover']):
